...
__global__ void angle_optimize_kernel(
    ...
    int n_angles,
    float rho_target,
    float* __restrict__ best_theta,
    float* __restrict__ best_phi,
    float* __restrict__ best_rho);
...
__global__ void angle_optimize_multibeam_kernel(
    ...
    float* __restrict__ best_theta,        // [num_beams]
    float* __restrict__ best_phi,          // [num_beams]
    float* __restrict__ best_rho,          // [num_beams]
    int num_beams);
